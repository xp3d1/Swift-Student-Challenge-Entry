            ...
            HStack{
                ZStack{
                    ...
                    VStack{
                        ...
                        HStack{
                            Text("We are almost ready to train the AI, however there is still a few things missing.").font(.system(size: 13, weight: .light, design: .default)).multilineTextAlignment(.leading).padding(.leading).padding(.trailing).padding(.top)
                            Spacer()
                        }.padding(.leading).padding(.top).padding(.trailing)
                        Group{
                            HStack{
