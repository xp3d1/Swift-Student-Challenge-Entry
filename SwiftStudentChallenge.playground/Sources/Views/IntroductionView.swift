            ...
            HStack{
                ZStack{
                    ...
                    VStack{
                        ...
                        HStack{
                            Text("In this Swift playground, we are going to learn about genetic algorithms and its application.\n\nTo do this, we are going to create an AI that will learn to complete a race course.\n\nGenetic algorithms actually follow similar patterns to real life evolution. There is a population made up of individuals, who are split into different species. Over time, the populations reproduce and mutate to produce improved future generations through natural selection.").font(.system(size: 13, weight: .light, design: .default)).multilineTextAlignment(.leading).padding()
                            Spacer()
                        }.padding()
                        Spacer()
                        Button(action: {
