                ...
                ZStack{
                    ...
                    VStack{
                        ...
                        Group{
                            ...
                            HStack{
                                Text("The environment favours individuals with certain advantageous traits. These individuals survive and reproduce to give improved offspring. This in turn results in favourable genes being more prominent than others in the population over time.").font(.system(size: 13, weight: .light, design: .default)).multilineTextAlignment(.leading).padding(.leading).padding(.trailing)
